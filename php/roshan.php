...
<html>
	...
	<div class="container-fluid">
		...
		<table class='table table-responsive' style="margin-top:20px; text-align:center;">
			...
			<tr><td>FROM JODHPUR, RAJASTHAN</td></tr>
		...
		<div class="row topnav" style="margin-top:100px;">
			...
			<div class="col-xs-offset-1 col-xs-2"><a href="https://www.facebook.com/profile.php?id=100013187715968" target="_blank" title="Connect on Facebook"><i class="fa fa-facebook" style="color:#3B5998; font-size:30px;"></i></a></div>
			<div class="col-xs-2"><a href="https://twitter.com/ROSHAN1532" target="_blank" title="Follow me on Twitter"><i class="fa fa-twitter" style="color:#1DA1F2; font-size:30px;"></i></a></div>
			<div class="col-xs-2"><a href="https://www.instagram.com/roshan_1532/?hl=en" target="_blank" title="Follow me on Instagram"><i class="fa fa-instagram" style="color:RGB(76,76,76); font-size:30px;"></i></a></div>
			<div class="col-xs-2"><a href="https://www.linkedin.com/in/roshan-lal-mali-38b106127/" target="_blank" title="Connect on LinkedIn"><i class="fa fa-linkedin" style="color:#0077B5; font-size:30px;"></i></a></div>
			<div class="col-xs-2"><a href="https://gmail.com/" target="_blank" title="Mail me on roshan1532.pali@gmail.com"><i class="fa fa-google" style="color:#db3236; font-size:30px;"></i></a></div>
			</div>
			</div>
			</div>
